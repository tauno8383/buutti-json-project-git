...
public:
    ...
    */
    ...
    /*
    Kirjoittaa päivitetyn deserialisoidun objektin JSON tiedostoon
    */

    bool writeFile() // -> Kirjoittaa alkuperäiseen tiedostoon päivitetyn objektin, josta JSON objekti on luettu.
    {
        return false;
    }
